...
// SystemLanguageNames matches the language labels and codes used by Stockholm.
// Validation uses an internal copy so callers cannot widen the accepted writes.
var SystemLanguageNames = func() map[LanguageCode]string {
